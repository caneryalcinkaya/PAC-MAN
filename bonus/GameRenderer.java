...
public class GameRenderer {
    ...
    // Determines the current animation frame
    ...
    // Calculates rotation angle for Pac-Man
    ...
    // Converts grid column to screen coordinate
    private double toScreenX(int col) {
        return col + 0.5;
    }

    // Converts grid row to screen coordinate
    ...
    // Chooses the correct ghost sprite
    ...
    // Main method to draw the current game frame
    public void drawGame() {
        ...
        // No extra overlay needed for backtracking
